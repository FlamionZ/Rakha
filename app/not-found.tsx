...
export default function NotFound() {
  ...
  return (
    <section className="flex min-h-[80svh] flex-col items-center justify-center px-5 py-32 text-center sm:px-8">
      ...
      <Link
        href="/"
        className="group mt-10 inline-flex items-center gap-2 rounded-full bg-accent px-6 py-3 font-mono text-sm font-semibold text-bg transition-shadow duration-300 hover:shadow-[0_0_32px_rgba(198,255,61,0.45)]"
      >
