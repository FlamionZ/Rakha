...
export function Nav() {
  ...
  return (
    <>
      ...
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[130] focus:rounded-lg focus:bg-accent focus:px-4 focus:py-2 focus:font-mono focus:text-xs focus:font-semibold focus:text-bg"
      >
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Magnetic strength={0.25} className="hidden sm:block">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-accent px-4 py-1.5 font-mono text-xs font-semibold text-bg transition-shadow duration-300 hover:shadow-[0_0_24px_rgba(198,255,61,0.45)]"
              >
            ...
            <button
              ...
              className="flex h-11 w-11 items-center justify-center rounded-lg border border-border text-fg md:hidden"
            >
